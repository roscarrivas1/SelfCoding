// Example program #1 from Chapter 9 of Absolute Beginner's Guide to
// C, 3rd Edition
// File Chapter9ex3.c

/* This program calculaates the average of four grades and also does
some otehr basic math. */
...
int main(void)
{
    ...
    so a multiple assignment statment works. */
    grade1 = grade3 = 88;
