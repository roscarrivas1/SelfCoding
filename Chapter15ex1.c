...
rating from 1 to 10. It will remember their favoite movie and their
...
int main(void)
{
    ...
    //initialie the favRating to 0 so any movie with any rating of
    ...
    // The loop will continue until they ener a number more than 0
