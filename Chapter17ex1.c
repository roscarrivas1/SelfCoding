// Example program #1 from Chapter 17 of Absoute Beginner's Guide
// to C, 3rd Editon
// File Chapter17ex1.c

/* This program presents a menu from choices, gets the user's choice,
...
int main(void)
{
    ...
    printf("2. Edit Existing Contacn\n");
