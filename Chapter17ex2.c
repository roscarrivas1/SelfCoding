// Example program #2 from Chapter 17 of Absolute Beginner's Guide
// to C, 3rd Edition
// File Chapter17ex2.c
...
information from the specific decade in that specific category. */
...
int main(void)
{
    ...
    do
    {
        ...
        switch (choice1)
        {
            // In the first case, the ouser picked the 1980s. Now it
            ...
            // The section for when the user selects the 200s
            case (3):
            {
                printf("\n\nWhat would you like to see?\n");
                printf("1. Baseball\n");
