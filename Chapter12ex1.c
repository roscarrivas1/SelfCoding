...
// to field a football team. If so, the statement will print.
...
// whether the number of Star War movies is less than months
...
// the statement will print.
    ...
    {
        printf("\nYou could read one Harry Potter book in a month.\n");
